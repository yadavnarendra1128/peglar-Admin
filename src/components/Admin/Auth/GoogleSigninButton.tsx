...
export default function GoogleSigninButton({ text,handleGoogleLogin }: { text: string, handleGoogleLogin:()=>void
 }) {
  return (
    <button
    onClick={()=>handleGoogleLogin}
      className="flex w-full items-center bg-white hover:bg-secondary/40 hover:cursor-pointer justify-center gap-3.5 rounded-lg border border-stroke bg-gray-2 p-[15px] font-medium hover:bg-opacity-50 dark:border-dark-3 dark:bg-dark-2 dark:hover:bg-opacity-50"
    >
      <span>
        <svg
          width="20"
