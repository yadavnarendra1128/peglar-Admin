...
// import "" from "../../../../public/img/navbar/line-1.png";
...
const Header = (props: {
  ...
  return (
    <header
      className="sticky top-0 z-999 flex w-full backdrop-blur"
    >
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm bg-transparent p-1.5 dark:border-dark-3 dark:bg-dark-2 lg:hidden"
          >
      ...
      {/* <Image
        className=" w-full h-15 mt-[52px] md:mt-[58px] lg:mt-[60px] fixed z-20"
        src={""}
        alt="Rough Line"
      /> */}
    </header>
