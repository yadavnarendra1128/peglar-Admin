  ...
  return (
    <>
      <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
            ...
            <div className="mt-4">
              {user?.name && (
                <div className="flex items-center justify-center gap-1">
                  ...
                  {user?.isVerified && <div>   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2bb13a" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" className="lucide lucide-shield-check-icon lucide-shield-check"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" /><path d="m9 12 2 2 4-4" /></svg></div>}
                </div>
        ...
        {!(user?.isVerified) && <div className="px-4 py-6 w-full">
          <button
          ...
          >
            {verificationMutation.isPending?"Verifying......":"Profile verify"}
          </button>
        </div>}
        {/* Submit Button */}
        <div className="px-4 py-6">
