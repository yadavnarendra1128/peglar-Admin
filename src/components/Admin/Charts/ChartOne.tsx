...
const ChartOne: React.FC = () => {
  ...
  // Function to generate the last 12 months dynamically
  function generateLast12Months() {
    ...
    const last12Months = [];
    for (let i = 0; i < 12; i++) {
      const monthIndex = (currentMonthIndex - i + 12) % 12; // Ensure index stays within 0-11 range
      last12Months.unshift(months[monthIndex]); // Add month to the start of the array
    }
